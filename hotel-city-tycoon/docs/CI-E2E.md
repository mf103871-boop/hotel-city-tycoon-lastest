...
**سجل التشغيلات المعتمدة:** S8 (02-09-2026): 60 / 6 / 16. تشغيل #2 (03-09-2026، خط الأساس + إصلاح القفل): 62 / 4 / 16 — `docs/ci/2026-09-03-run2/`. **تشغيل #4 (03-09-2026، بعد دمج تدقيق 03-09-2026 كاملًا): 72 / 0 / 10 في 2.0 دقيقة — `docs/ci/2026-09-03-run4/`.** المتخطاة العشر هي اختبارات القماشة (`NO_3D`) واختبارات التوسعة التي تتخطى نفسها لفندق مستوى 1.
