...
08-09-2026 الأردن / 07-09-2026 UTC. الحالة: **IMPLEMENTED — الاعتماد البصري داخل المحرك معلق**.
...
| `npm run mobile:build` | ناجح؛ JS gzip نحو 335KB / 350KB، الفن والصوت نحو 8816KB / 12288KB |
...
Node المحلي 24.19.0؛ نتيجة CI على Node 22 توثق في وصف PR عند توفرها. لا توجد نتيجة جديدة لقياس iPhone/Android أو فيديو دورة لعب أو اعتماد رسوم GPU. معاينة الفرع في المتصفح السحابي غير متاحة بعد خطأ ERR_BLOCKED_BY_CLIENT المسجل في HC-VIS-001A؛ لا تُستبدل بلقطة من الفرع المنشور القديم.
