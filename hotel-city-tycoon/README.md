...
Current phase: P2, making the hotel visibly alive — step HC-P2-S2, continuous
day/night lighting (P1, the visible decor system, remains in progress). Step
...
src/render/    Pixi v8 canvas: camera, culling, pools, gestures, characters,
               continuous day/night lighting, three backends (webgpu / webgl / canvas)
